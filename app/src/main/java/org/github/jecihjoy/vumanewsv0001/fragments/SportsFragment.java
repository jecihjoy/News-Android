...
import org.github.jecihjoy.vumanewsv0001.adapters.SportsRecyclerViewAdapter;
...
public class SportsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        recyclerViewAdapter = new SportsRecyclerViewAdapter(
                getActivity().getApplicationContext(),sNews
        );
        Toast.makeText(getActivity().getApplicationContext(), "Testing sports news", Toast.LENGTH_LONG).show();
        ...
        StringRequest request = new StringRequest(uri,
                new com.android.volley.Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        data = response;
                        sNews = JsonParser.parseFeed(data);
                        recyclerViewAdapter.setNewsList(sNews);
                    }
                },
